...
def build_embeds():
    ...
    <style>
      ...
      body { background: transparent !important; color: var(--text-main) !important; padding: 0 !important; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif !important; }
      ...
      .btn-link { border: 1px solid var(--border) !important; color: var(--text-muted) !important; background: var(--btn-bg) !important; }
      .btn-link:hover { background: var(--btn-hover) !important; color: var(--text-main) !important; border-color: var(--text-muted) !important; }
      ...
      .filter-bar button { background: var(--btn-bg) !important; border: 1px solid var(--border) !important; color: var(--text-main) !important; }
      .filter-bar button:hover { background: var(--btn-hover) !important; color: var(--text-main) !important; }
      .filter-bar input[type="text"], .filter-bar input[type="number"] { background: var(--btn-bg) !important; border: 1px solid var(--border) !important; color: var(--text-main) !important; }
