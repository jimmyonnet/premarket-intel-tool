...
def build_embeds():
    ...
    <style>
      ...
      th { font-size: 13px !important; background: #1a2132 !important; border-bottom: 1px solid #253046 !important; }
      td { font-size: 13px !important; border-bottom: 1px solid #253046 !important; }
      ...
      .clickable-row:hover td { background: #1a2132 !important; }
      .detail-row td { background: #0B0E14 !important; border-bottom: 1px solid #1a2132 !important; }
      .detail-content { background: #0B0E14 !important; padding: 12px !important; }
      .raw-text { background: #131824 !important; border: 1px solid #253046 !important; }
